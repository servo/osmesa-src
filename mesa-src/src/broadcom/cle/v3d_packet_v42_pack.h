...
enum V3D42_Border_Colour_Mode {
        V3D_BORDER_COLOUR_0000               =      0,
        V3D_BORDER_COLOUR_0001               =      1,
        V3D_BORDER_COLOUR_1111               =      2,
        V3D_BORDER_COLOUR_FOLLOWS            =      7,
};
...
struct V3D42_STORE_TILE_BUFFER_GENERAL {
   ...
   enum V3D42_Decimate_Mode             decimate;
   bool                                 a_dithered;
   bool                                 bgr_dithered;
   bool                                 flip_y;
                                     ...
                                     const struct V3D42_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   ...
   cl[ 2] = __gen_uint(values->output_image_format, 4, 9) |
            __gen_uint(values->decimate, 2, 3) |
            __gen_uint(values->a_dithered, 1, 1) |
            __gen_uint(values->bgr_dithered, 0, 0);
                                       ...
                                       struct V3D42_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   ...
   values->decimate = __gen_unpack_uint(cl, 18, 19);
   values->a_dithered = __gen_unpack_uint(cl, 17, 17);
   values->bgr_dithered = __gen_unpack_uint(cl, 16, 16);
...
#define V3D42_INDEXED_PRIMITIVE_LIST_opcode     32
#define V3D42_INDEXED_PRIMITIVE_LIST_header     \
   .opcode                              =     32

struct V3D42_INDEXED_PRIMITIVE_LIST {
   uint32_t                             opcode;
...
static inline void
V3D42_INDEXED_PRIMITIVE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D42_INDEXED_PRIMITIVE_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_INDEXED_PRIMITIVE_LIST_length     10
#ifdef __gen_unpack_address
static inline void
V3D42_INDEXED_PRIMITIVE_LIST_unpack(const uint8_t * restrict cl,
                                    struct V3D42_INDEXED_PRIMITIVE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST_opcode     34
#define V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST_header\
   .opcode                              =     34

struct V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST {
   uint32_t                             opcode;
   uint32_t                             index_offset;
...
static inline void
V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST_length     14
#ifdef __gen_unpack_address
static inline void
V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST_unpack(const uint8_t * restrict cl,
                                              struct V3D42_INDEXED_INSTANCED_PRIMITIVE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_VERTEX_ARRAY_PRIMITIVES_opcode     36
#define V3D42_VERTEX_ARRAY_PRIMITIVES_header    \
   .opcode                              =     36

struct V3D42_VERTEX_ARRAY_PRIMITIVES {
   uint32_t                             opcode;
...
static inline void
V3D42_VERTEX_ARRAY_PRIMITIVES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D42_VERTEX_ARRAY_PRIMITIVES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_VERTEX_ARRAY_PRIMITIVES_length     10
#ifdef __gen_unpack_address
static inline void
V3D42_VERTEX_ARRAY_PRIMITIVES_unpack(const uint8_t * restrict cl,
                                     struct V3D42_VERTEX_ARRAY_PRIMITIVES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES_opcode     38
#define V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES_header\
   .opcode                              =     38

struct V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES {
   uint32_t                             opcode;
   uint32_t                             index_of_first_vertex;
   uint32_t                             number_of_instances;
   uint32_t                             instance_length;
...
static inline void
V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES_length     14
#ifdef __gen_unpack_address
static inline void
V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES_unpack(const uint8_t * restrict cl,
                                               struct V3D42_VERTEX_ARRAY_INSTANCED_PRIMITIVES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_PRIMITIVE_LIST_FORMAT_opcode     56
#define V3D42_PRIMITIVE_LIST_FORMAT_header      \
   .opcode                              =     56

struct V3D42_PRIMITIVE_LIST_FORMAT {
   uint32_t                             opcode;
   uint32_t                             data_type;
...
static inline void
V3D42_PRIMITIVE_LIST_FORMAT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D42_PRIMITIVE_LIST_FORMAT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_PRIMITIVE_LIST_FORMAT_length      2
#ifdef __gen_unpack_address
static inline void
V3D42_PRIMITIVE_LIST_FORMAT_unpack(const uint8_t * restrict cl,
                                   struct V3D42_PRIMITIVE_LIST_FORMAT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_STENCIL_CONFIG_opcode           80
#define V3D42_STENCIL_CONFIG_header             \
   .opcode                              =     80

struct V3D42_STENCIL_CONFIG {
   uint32_t                             opcode;
...
static inline void
V3D42_STENCIL_CONFIG_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D42_STENCIL_CONFIG * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_STENCIL_CONFIG_length            6
#ifdef __gen_unpack_address
static inline void
V3D42_STENCIL_CONFIG_unpack(const uint8_t * restrict cl,
                            struct V3D42_STENCIL_CONFIG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_BLEND_CONFIG_opcode             84
#define V3D42_BLEND_CONFIG_header               \
   .opcode                              =     84

struct V3D42_BLEND_CONFIG {
   uint32_t                             opcode;
   uint32_t                             vg_coverage_modes;
   uint32_t                             render_target_mask;
   enum V3D42_Blend_Factor              colour_blend_dst_factor;
   enum V3D42_Blend_Factor              colour_blend_src_factor;
   enum V3D42_Blend_Mode                colour_blend_mode;
...
static inline void
V3D42_BLEND_CONFIG_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D42_BLEND_CONFIG * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
   ...
   cl[ 4] = __gen_uint(values->vg_coverage_modes, 4, 5) |
            __gen_uint(values->render_target_mask, 0, 3);

}

#define V3D42_BLEND_CONFIG_length              5
#ifdef __gen_unpack_address
static inline void
V3D42_BLEND_CONFIG_unpack(const uint8_t * restrict cl,
                          struct V3D42_BLEND_CONFIG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_BLEND_CONSTANT_COLOUR_opcode     86
#define V3D42_BLEND_CONSTANT_COLOUR_header      \
   .opcode                              =     86

struct V3D42_BLEND_CONSTANT_COLOUR {
   uint32_t                             opcode;
   uint32_t                             alpha_f16;
   uint32_t                             blue_f16;
   uint32_t                             green_f16;
...
static inline void
V3D42_BLEND_CONSTANT_COLOUR_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D42_BLEND_CONSTANT_COLOUR * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_BLEND_CONSTANT_COLOUR_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_BLEND_CONSTANT_COLOUR_unpack(const uint8_t * restrict cl,
                                   struct V3D42_BLEND_CONSTANT_COLOUR * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_COLOUR_WRITE_MASKS_opcode       87
#define V3D42_COLOUR_WRITE_MASKS_header         \
   .opcode                              =     87

struct V3D42_COLOUR_WRITE_MASKS {
   uint32_t                             opcode;
   uint32_t                             reserved;
...
static inline void
V3D42_COLOUR_WRITE_MASKS_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D42_COLOUR_WRITE_MASKS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_COLOUR_WRITE_MASKS_length        5
#ifdef __gen_unpack_address
static inline void
V3D42_COLOUR_WRITE_MASKS_unpack(const uint8_t * restrict cl,
                                struct V3D42_COLOUR_WRITE_MASKS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_CONFIGURATION_BITS_opcode       96
#define V3D42_CONFIGURATION_BITS_header         \
   .opcode                              =     96

struct V3D42_CONFIGURATION_BITS {
   uint32_t                             opcode;
...
static inline void
V3D42_CONFIGURATION_BITS_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D42_CONFIGURATION_BITS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_CONFIGURATION_BITS_length        4
#ifdef __gen_unpack_address
static inline void
V3D42_CONFIGURATION_BITS_unpack(const uint8_t * restrict cl,
                                struct V3D42_CONFIGURATION_BITS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
struct V3D42_NON_PERSPECTIVE_FLAGS {
   ...
   enum V3D42_Varying_Flags_Action      action_for_non_perspectivey_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};
                                 ...
                                 const struct V3D42_NON_PERSPECTIVE_FLAGS * restrict values)
{
   ...
   cl[ 1] = __gen_uint(values->action_for_non_perspective_flags_of_higher_numbered_varyings, 6, 7) |
            __gen_uint(values->action_for_non_perspectivey_flags_of_lower_numbered_varyings, 4, 5) |
            __gen_uint(values->varying_offset_v0, 0, 3);
                                   ...
                                   struct V3D42_NON_PERSPECTIVE_FLAGS * restrict values)
{
   ...
   values->action_for_non_perspectivey_flags_of_lower_numbered_varyings = __gen_unpack_uint(cl, 12, 13);
   values->varying_offset_v0 = __gen_unpack_uint(cl, 8, 11);
}
#endif
...
struct V3D42_NUMBER_OF_LAYERS {
   uint32_t                             opcode;
   uint32_t                             number_of_layers_minus_1;
};
                            ...
                            const struct V3D42_NUMBER_OF_LAYERS * restrict values)
{
   ...
   cl[ 1] = __gen_uint(values->number_of_layers_minus_1, 0, 7);
...
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->number_of_layers_minus_1 = __gen_unpack_uint(cl, 8, 15);
}
#endif


#define V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1_opcode    120
#define V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1_header\
   .opcode                              =    120

struct V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1 {
   uint32_t                             opcode;
   uint32_t                             height_in_pixels_minus_1;
   uint32_t                             width_in_pixels_minus_1;
...
static inline void
V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
   ...
   cl[ 2] = __gen_uint(values->double_buffer_in_non_ms_mode, 7, 7) |
            ...
            __gen_uint(values->number_of_render_targets_minus_1, 0, 3);

   cl[ 3] = 0;
   cl[ 4] = 0;
   cl[ 5] = __gen_uint(values->width_in_pixels_minus_1, 0, 11);

   cl[ 6] = __gen_uint(values->width_in_pixels_minus_1, 0, 11) >> 8;

   cl[ 7] = __gen_uint(values->height_in_pixels_minus_1, 0, 11);

   cl[ 8] = __gen_uint(values->height_in_pixels_minus_1, 0, 11) >> 8;

}

#define V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1_unpack(const uint8_t * restrict cl,
                                                   struct V3D42_TILE_BINNING_MODE_CONFIGURATION_PART1 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->height_in_pixels_minus_1 = __gen_unpack_uint(cl, 56, 67);
   values->width_in_pixels_minus_1 = __gen_unpack_uint(cl, 40, 51);
   ...
   values->number_of_render_targets_minus_1 = __gen_unpack_uint(cl, 16, 19);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION_header\
   .opcode                              =    121,  \
   .sub_id                              =      0

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION {
   uint32_t                             opcode;
   uint32_t                             pad;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                  const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION_unpack(const uint8_t * restrict cl,
                                                                    struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_COMMON_CONFIGURATION * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG_header\
   .opcode                              =    121,  \
   .sub_id                              =      1

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG {
   uint32_t                             opcode;
   uint32_t                             pad;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                  const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG_unpack(const uint8_t * restrict cl,
                                                                    struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_RENDER_TARGET_CONFIG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES_header\
   .opcode                              =    121,  \
   .sub_id                              =      2

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES {
   uint32_t                             opcode;
   uint32_t                             unused;
   float                                z_clear_value;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                    const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES_unpack(const uint8_t * restrict cl,
                                                                      struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_Z_STENCIL_CLEAR_VALUES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1_header\
   .opcode                              =    121,  \
   .sub_id                              =      3

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1 {
   uint32_t                             opcode;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1_unpack(const uint8_t * restrict cl,
                                                                  struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART1 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2_header\
   .opcode                              =    121,  \
   .sub_id                              =      4

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2 {
   uint32_t                             opcode;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2_unpack(const uint8_t * restrict cl,
                                                                  struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART2 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3_opcode    121
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3_header\
   .opcode                              =    121,  \
   .sub_id                              =      5

struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3 {
   uint32_t                             opcode;
   uint32_t                             pad;
...
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                const struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3_unpack(const uint8_t * restrict cl,
                                                                  struct V3D42_TILE_RENDERING_MODE_CONFIGURATION_CLEAR_COLORS_PART3 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION_opcode    122
#define V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION_header\
   .opcode                              =    122

struct V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION {
   uint32_t                             opcode;
...
static inline void
V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION_length      9
#ifdef __gen_unpack_address
static inline void
V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION_unpack(const uint8_t * restrict cl,
                                                         struct V3D42_MULTICORE_RENDERING_SUPERTILE_CONFIGURATION * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
struct V3D42_GL_SHADER_STATE_RECORD {
   ...
   uint32_t                             min_coord_shader_input_segments_required_in_play_minus_1;
   ...
   uint32_t                             min_vertex_shader_input_segments_required_in_play_minus_1;
                                  ...
                                  const struct V3D42_GL_SHADER_STATE_RECORD * restrict values)
{
   ...
   cl[ 5] = __gen_uint(values->coordinate_shader_input_vpm_segment_size, 0, 3) |
            __gen_uint(values->min_coord_shader_input_segments_required_in_play_minus_1, 4, 7);
   ...
   cl[ 7] = __gen_uint(values->vertex_shader_input_vpm_segment_size, 0, 3) |
            __gen_uint(values->min_vertex_shader_input_segments_required_in_play_minus_1, 4, 7);
                                    ...
                                    struct V3D42_GL_SHADER_STATE_RECORD * restrict values)
{
   ...
   values->min_coord_shader_input_segments_required_in_play_minus_1 = __gen_unpack_uint(cl, 44, 47);
   ...
   values->min_vertex_shader_input_segments_required_in_play_minus_1 = __gen_unpack_uint(cl, 60, 63);
   values->address_of_default_attribute_values = __gen_unpack_address(cl, 64, 95);
   values->fragment_shader_code_address = __gen_unpack_address(cl, 96, 127);
                                  ...
                                  const struct V3D42_TMU_CONFIG_PARAMETER_2 * restrict values)
{
   ...
   cl[ 1] = __gen_uint(values->pad, 1, 23) |
            __gen_uint(values->lod_query, 0, 0) |
            __gen_sint(values->offset_t, 4, 7) |
            __gen_sint(values->offset_s, 0, 3);

   cl[ 2] = __gen_uint(values->pad, 1, 23) >> 8 |
            __gen_uint(values->op, 4, 7) |
            __gen_sint(values->offset_r, 0, 3);

   cl[ 3] = __gen_uint(values->pad, 1, 23) >> 16;
...
{
   values->pad = __gen_unpack_uint(cl, 9, 31);
   values->lod_query = __gen_unpack_uint(cl, 8, 8);
...
#define SWIZZLE_ALPHA                            5
   ...
   bool                                 reverse_standard_border_colour;
   bool                                 ahdr;
   bool                                 srgb;
                                ...
                                const struct V3D42_TEXTURE_SHADER_STATE * restrict values)
{
   ...
   cl[ 0] = __gen_address_offset(&values->texture_base_pointer) |
            __gen_uint(values->reverse_standard_border_colour, 5, 5) |
                                  ...
                                  struct V3D42_TEXTURE_SHADER_STATE * restrict values)
{
   ...
   values->reverse_standard_border_colour = __gen_unpack_uint(cl, 5, 5);
...
struct V3D42_SAMPLER_STATE {
   uint32_t                             border_colour_alpha;
   uint32_t                             border_colour_blue;
   uint32_t                             border_colour_green;
   uint32_t                             border_colour_red;
   uint32_t                             maximum_anisotropy;
   enum V3D42_Border_Colour_Mode        border_colour_mode;
   bool                                 wrap_i_border;
                         ...
                         const struct V3D42_SAMPLER_STATE * restrict values)
{
   ...
   cl[ 7] = __gen_uint(values->maximum_anisotropy, 5, 6) |
            __gen_uint(values->border_colour_mode, 2, 4) |
            __gen_uint(values->wrap_i_border, 1, 1) |
            __gen_uint(values->wrap_r, 6, 8) >> 8;


   memcpy(&cl[8], &values->border_colour_red, sizeof(values->border_colour_red));

   memcpy(&cl[12], &values->border_colour_green, sizeof(values->border_colour_green));

   memcpy(&cl[16], &values->border_colour_blue, sizeof(values->border_colour_blue));

   memcpy(&cl[20], &values->border_colour_alpha, sizeof(values->border_colour_alpha));
}
...
{
   values->border_colour_alpha = __gen_unpack_uint(cl, 160, 191);
   values->border_colour_blue = __gen_unpack_uint(cl, 128, 159);
   values->border_colour_green = __gen_unpack_uint(cl, 96, 127);
   values->border_colour_red = __gen_unpack_uint(cl, 64, 95);
   values->maximum_anisotropy = __gen_unpack_uint(cl, 61, 62);
   values->border_colour_mode = __gen_unpack_uint(cl, 58, 60);
